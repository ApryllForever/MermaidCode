...
{
	public class SapphireQuestBoard : Billboard
	{
		...
		internal SapphireQuestBoard(QuestData questData, string boardType = "") : base(dailyQuest: true)
		{
			...
			{
				this.dailyQuest = questData.dailySapphireBoardQuest;
				this.acceptQuestButton.visible = !questData.acceptedDailySapphireBoardQuest;
			}
			if (dailyQuest != null)
			{
			...
			Texture2D billboardTexture = Game1.temporaryContent.Load<Texture2D>("LooseSprites\\SapphireBoard"); 
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			...
			if (this.acceptQuestButton.visible && this.acceptQuestButton.containsPoint(x, y) && this.dailyQuest != null)
			{
				...
				{
					this.questData.acceptedDailySapphireBoardQuest = true;
				}
