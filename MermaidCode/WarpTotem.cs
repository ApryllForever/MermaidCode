...
namespace RestStopCode
{
    ...
    {
        static readonly string Destination = "custom_RealmofSpirits";
        static readonly int Dest_X = 2;
        static readonly int Dest_Y = 45;
        ...
        {
            Totem = "(O)ApryllForever.RiseMermaids_RealmofSpiritsTotem";
        }
