...
{
    internal static class WarpTotem3
    {
        static readonly string Destination = "Custom_DungeonEntrance";
        ...
        {
            Totem = "(O)ApryllForever.RiseMermaids_HellDungeonTotem";
        }
        ...
        private static void OnButtonPressed(object sender, ButtonPressedEventArgs e)
        {
            ...
            if (e.Button.IsActionButton())
            {
                try
                {
                    ...
                    {
                        Monitor.Log($"RestStop: Using Warp Totem: Hell Dungeon");
                        Game1.player.reduceActiveItemByOne();
                        DoTotemWarpEffects(Game1.player, (f) => DirectWarp());
                    }
                }
