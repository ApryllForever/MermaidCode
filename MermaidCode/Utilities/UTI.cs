...
namespace UtilitiesStuff
{
    ...
    internal static class UtilFunctions
    {
        ...
        public static bool SpawnForage(string index, GameLocation location, Vector2 tile, bool destroyOvernight)
        {
            StardewValley.Object forageObj;
            forageObj = new StardewValley.Object(tile, index); //generate the object (use the constructor that allows pickup)
            if (destroyOvernight)
